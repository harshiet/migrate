...
public class RallyReadApi extends RallyRestApi {
	...
	public RallyReadApi(String url, String username, String password) throws URISyntaxException {
	...
	public JsonObject getProjectDetails(JsonElement project) throws RestClientException, URISyntaxException {
		...
		return getObjectFromRef(ref, ArtifactType.PROJECT).get("Project").getAsJsonObject();
	}
